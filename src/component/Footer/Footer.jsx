...
const Footer = () => {
  return (
    <div className="bg-gray-800 lg:pl-20 w-screen relative overflow-hidden">
      <section data-aos="fade-up" className="max-w-[1200px] text-white">
        <div className=" grid md:grid-cols-3 py-5">
          {/* first column */}
          <div className=" py-8 px-4 ">
            <h1 className="sm:text-3xl text-xl font-bold sm:text-left flex justify-center mb-3">
              Be Ready To Grow
            </h1>
          ...
          <div className="grid grid-cols-2 align- sm:grid-cols-3 col-span-2 md:pl-10 ">
            <div className="">
              <div className="py-8 px-4 ">
